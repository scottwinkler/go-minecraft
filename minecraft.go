...
type Config struct {
	// The address of the Minecraft API.
	Address string
...
// Client is the Minecraft API client. It provides the basic
// connectivity and configuration for accessing the Minecraft API.
type Client struct {
	baseURL *url.URL
	headers http.Header
	http    *http.Client
